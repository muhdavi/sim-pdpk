        ...
        <div class="max-w-7xl min-h-screen mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white border-b border-gray-200">
                    ...
                    @endif
                    <a href="{{ route('usulan.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded m-2 float-right">
                        Buat Usulan
                    </a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($usulan->jenis_kebutuhan == 1)
                                        <span class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-green-600 rounded-full">{{ __('Perpanjangan') }}</span>
                                    @else
                                        <span class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-yellow-600 rounded-full">{{ __('Pengusulan Baru') }}</span>
                                    @endif
                                </td>
                                <td class="px-2 py-2 text-gray-500">
                                    <div class="flex space-x-2 float-right">
                                        <button onclick="window.location='{{ route('usulan.show', $usulan->id) }}'"class="border-2 border-black-200 rounded-md p-1 hover:bg-green-300" title="Lihat Usulan">
                                        ...
                                        @if(is_null($usulan->nomor_pertek))
                                            ...
                                            <button onclick="window.location='{{ route('usulan.pegawai', $usulan->id) }}'"
                                                    class="border-2 border-black-200 rounded-md p-1 hover:bg-green-300" title="Tambah Pegawai">
                                                <svg viewBox="0 0 24 24" stroke="currentColor" fill="none" class="h-4 w-4 text-gray-500">
                                            ...
                                            @else
                                            <button onclick="window.open('{{ route('usulan.print', $usulan->id) }}', '_blank')" class="border-2 border-black-200 rounded-md p-1 hover:bg-green-300" title="Cetak Usulan">
                                            ...
                                            <button onclick="window.location='{{ route('usulan.verifikasi', $usulan->id) }}'" class="border-2 border-black-200 rounded-md p-1 hover:bg-green-300" title="Periksa Usulan">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-4 w-4 text-gray-500">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                          d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                                                </svg>
                                            ...
                                            @endhasanyrole
                                            @hasanyrole('Admin')
                                            <button onclick="window.location='{{ route('usulan.pertek', $usulan->id) }}'" class="border-2 border-black-200 rounded-md p-1 hover:bg-green-300" title="Input Pertek">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-4 w-4 text-gray-500">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                          d="M5 13l4 4L19 7"/>
                                                </svg>
                                        ...
                                        @else
                                            ...
                                            <button onclick="window.open('{{ route('usulan.print.sk', $usulan->id) }}', '_blank')" class="border-2 border-green-500 bg-green-300 rounded-md p-1 hover:bg-green-500" title="Cetak SK">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500 icon icon-tabler icon-tabler-printer" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <rect x="0" y="0" width="24" height="24" stroke="none"></rect>
                                                    <path d="M17 17h2a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h2"/>
                                                    <path d="M17 9v-4a2 2 0 0 0 -2 -2h-6a2 2 0 0 0 -2 2v4"/>
