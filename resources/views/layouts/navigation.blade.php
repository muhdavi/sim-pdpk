<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 top-0 sticky z-30">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- <x-nav-link :href="route('dpa.index')" :active="request()->routeIs('dpa.index')">
                        {{ __('DPA') }}
                    </x-nav-link> --}}
                    @endhasanyrole
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @hasanyrole('Admin|Keuangan')
            <x-responsive-nav-link :href="route('perangkat_daerah.index')" :active="request()->routeIs('perangkat_daerah.index')">
                {{ __('Perangkat Daerah') }}
            </x-responsive-nav-link>
            @endhasanyrole
            @hasanyrole('Kepegawaian|Admin')
