...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #1b2aab 0%, #0b1952 100%);
        }
    </style>
</head>
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Nunito', sans-serif;">
<!--Nav-->
<nav id="header" class="fixed w-full z-30 top-0 text-white">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
            <a class="toggleColour flex text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                <img id="img2" alt="SIM-PDPK" src="{{ asset('assets/images/SIM-PDPK-BIRU.png') }}">
            </a>
        </div>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
            <ul class="list-reset lg:flex justify-end flex-1 items-center">
                ...
                <li class="mr-3">
                    <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Beranda</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#pdpk">PDPK</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#usulan">USULAN</a>
                </li>
                <li class="mr-3">
                    <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#kontak">Kontak Kami</a>
                </li>
            </ul>
            @if (Route::has('login'))
                    @auth
                    ...
                    <a href="{{ route('login') }}"
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                                Register</a>
                        @endif
                    @endauth
                </div>
    ...
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-3/6 justify-center items-start text-center md:text-left">
            ...
            <p class="leading-normal text-2xl mb-8">
                Sistem Informasi Pegawai Daerah dengan Perjanjian Kerja
            </p>
            <a href="https://www.youtube.com/channel/UCI0I_pFZ1ApY5YoiHanIBZw" target="_blank" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                Jangan Lupa Subcribe!
            </a>
        </div>
        <!--Right Col-->
        <div class="w-full md:w-3/6 py-6 text-center">
            <img class="w-full md:w-4/5 z-50" src="{{ asset('assets/images/hero-1.png') }}" alt="hero image" />
        </div>
    </div>
</div>
    ...
    <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
            <div class="w-5/6 sm:w-1/2 p-6">
                ...
                <p class="text-gray-600 mb-8">Penyampaian usulan Tenaga Kontrak oleh Kepala Perangkat Daerah sesuai dengan DPA kepada PPK.</p>
                {{--Images from: <a class="text-pink-500 underline" href="https://undraw.co/">undraw.co</a>--}}
            </div>
            <div class="w-full sm:w-1/2 p-6">
                <svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#1c3faa" />
                    ...
                    <circle cx="193" cy="127.75" r="6" fill="#1c3faa" />
                    <circle cx="208" cy="127.75" r="6" fill="#1c3faa" />
                    <circle cx="223" cy="127.75" r="6" fill="#1c3faa" />
                    ...
                    <path
                        ...
                        fill="#3f3d56"
                    />
                    <rect x="604" y="260.14" width="347" height="11" rx="1.24" fill="#1c3faa" opacity=".3" />
                    <rect x="604" y="392.07" width="347" height="11" rx="1.24" fill="#1c3faa" opacity=".3" />
                    <rect x="878" y="279.75" width="73" height="25" rx="1.24" fill="#1c3faa" />
                    <rect x="878" y="411.75" width="73" height="25" rx="1.24" fill="#1c3faa" />
            ...
            <div class="w-full sm:w-1/2 p-6 mt-6">
                <div class="align-middle">
                    ...
                    <p class="text-gray-600 mb-8">
                        Usulan yang telah dibuat dapat dipantau melalui SIM-PDPK, sehingga para pengusul dapat melihat usulannya kapan saja dan dimana saja.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="bg-white shadow-md rounded my-6">
                        <table class="min-w-max w-full table-auto">
                            ...
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-center">Satuan Kerja</th>
                                <th class="py-3 px-6 text-center">Jenis Usulan</th>
                            ...
                            @foreach($usulans as $usulan)
                                @if($no % 2 == 0)
                                    <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                        <td class="py-3 text-center font-bold">{{ $no = $no + 1 }}</td>
                                        <td class="py-3 px-6 text-center whitespace-nowrap">
                                            <p class="font-bold">{{ Date('d-m-Y', strtotime($usulan->tanggal)) }}</p>
                                        </td>
                                        <td class="py-3 px-6 text-left">
                                            <p class="font-bold">{{ $usulan->satuan_kerja->satuan_kerja }}</p>
                                        </td>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            @if($usulan->nomor_pertek)
                                                <span class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-green-600 rounded-full">{{ __('Selesai') }}</span>
                                            @else
                                                <span class="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-gray-600 rounded-full">{{ __('Belum Selesai') }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                @else
                                    <tr class="border-b border-gray-200 bg-white-50 hover:bg-gray-100">
                                        <td class="py-3 text-center font-bold">{{ $no = $no + 1 }}</td>
                                        <td class="py-3 px-6 text-center whitespace-nowrap">
                                            <p class="font-bold">{{ Date('d-m-Y', strtotime($usulan->tanggal)) }}</p>
                                        </td>
    ...
    <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            ...
            <div class="max-w-sm bg-white border-2 border-gray-300 p-6 rounded-md tracking-wide shadow-lg">
                ...
                <div id="quote">
                    <p class="italic text-gray-600">"SIM-PDPK berawal dari Mimpi, Mimpi memudahkan Kerja, dan SIM-PDPK mengajari kita bekerja itu bukan hanya dengan kerja keras tapi juga harus kerja cerdas."</p>
                </div>
            </div>
            <!-- End of component -->
        </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            ...
            <div class="max-w-sm bg-white border-2 border-gray-300 p-6 rounded-md tracking-wide shadow-lg">
                ...
                <div id="quote">
                    <p class="italic text-gray-600">"SIM-PDPK memberikan yang dibutuhkan bukan yang diinginkan. Semoga SIM-PDPK terus diupdate sehingga dapat membantu semua Tenaga Kontrak Aceh Timur."</p>
                </div>
            </div>
            <!-- End of component -->
        </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            ...
            <div class="max-w-sm bg-white border-2 border-gray-300 p-6 rounded-md tracking-wide shadow-lg">
                ...
                <div id="quote">
                    <p class="italic text-gray-600">"SIM-PDPK mengajarkan kita mudahnya bekerja dengan teknologi IT"</p>
                </div>
            </div>
...
<section class="container mx-auto text-center py-6 mb-12">
    <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">
        <a name="kontak">Kontak Kami</a>
    </h1>
    <div class="w-full mb-4">
        <div class="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
    </div>
    <h3 class="my-4 text-3xl leading-tight">
        Ada yang tidak Anda pahami tentang SIM-PDPK?
    </h3>
    <div class="w-full mb-4">
        <div class="h-1 mx-auto w-1/6 my-0 py-0 p-2 md:w-40 hover:underline focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            <div class="flex items-center p-4 bg-green-200 rounded-full shadow-xs cursor-pointer hover:bg-green-500 hover:text-gray-100">
                ...
                <div>
                  <a href="https://wa.me/6285319528398?text=Nama%20saya%20...%20dari%20OPD%20...%20ingin%20tanya%20" target="_blank" class="text-gray-800 font-bold ml-2 ">
                    Klik Disini!
                  </a>
                </div>
            </div>
...
<!--Footer-->
<footer class="bg-blue-900 border-t-4 border-indigo-900">
    <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
            <div class="flex-1 mb-6 text-black">
                <a class="flex text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                    <!--Icon from: http://www.potlabicons.com/ -->
                    <img alt="SIM-PDPK" src="{{ asset('assets/images/SIM-PDPK-PUTIH.png') }}">
                </a>
            </div>
            <div class="flex-1">
                ...
                <ul class="list-reset mb-6">
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="https://acehtimurkab.go.id/" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Pemerintah Kabupaten Aceh Timur</a>
                    </li>
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="https://bkpsdm.acehtimurkab.go.id/" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">BKPSDM Aceh Timur</a>
                    </li>
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="https://diskominfo.acehtimurkab.go.id/" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">DISKOMINFO Aceh Timur</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex-1">
                ...
                <ul class="list-reset mb-6">
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="https://www.youtube.com/channel/UCI0I_pFZ1ApY5YoiHanIBZw" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Youtube</a>
                    </li>
                    <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                        <a href="https://www.instagram.com/bkpsdm.acehtimur/" target="_blank" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Instagram</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex-1">
                <div>
                    <div class="block w-full">
                        <iframe src="https://www.youtube.com/embed/RQsqKxXE5Hs" title="SIM-PDPK Aceh Timur" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
