        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="post" action="{{ route('perangkat_daerah.update', $satuan_kerja->id) }}">
                        @csrf
                    <div class="flex">
                    ...
                    <div class="mt-4 flex">
                        ...
                        @hasrole('Admin')
                            <x-input class="appearance-none block w-96 py-3 px-4 py-2 mx-2" type="text" id="nama_kepala" name="nama_kepala" value="{{ $satuan_kerja->nama_kepala }}" autofocus required/>
                        @else
                    ...
                    <div class="mt-4 flex">
                        ...
                        @hasrole('Keuangan')
                            <x-input class="appearance-none block w-20 py-3 px-4 py-2 mx-2" type="text" id="kouta" name="kouta" value="{{ $satuan_kerja->kouta }}" autofocus required/>
                        @else
                    ...
                    <div class="mt-4 flex">
                        ...
                        @hasrole('Keuangan')
                            <x-input class="appearance-none block w-20 py-3 px-4 py-2 mx-2" type="text" id="jumlah_bulan" name="jumlah_bulan" value="{{ $satuan_kerja->jumlah_bulan }}" autofocus required/>
                        @else
